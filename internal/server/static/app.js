document.addEventListener('DOMContentLoaded', () => {
    const ALL_ICONS = [
        'bookmark', 'folder', 'globe', 'git-branch', 'server', 'layout-dashboard', 'mail', 'hard-drive',
        'wifi', 'box', 'shield', 'activity', 'star', 'link', 'terminal', 'database',
        'cloud', 'house', 'lock', 'file-text', 'code', 'settings', 'folder-open', 'files',
        'file-code', 'book-open', 'library', 'clipboard', 'archive', 'git-merge', 'bug', 'braces',
        'cpu', 'monitor', 'network', 'router', 'key', 'shield-check', 'container', 'package',
        'calendar', 'clock', 'message-circle', 'inbox', 'phone', 'bell', 'list-todo', 'camera',
        'image', 'video', 'music', 'gauge', 'plug', 'lightbulb', 'heart', 'zap',
        'external-link', 'pin', 'tag', 'rocket', 'search', 'compass', 'map', 'map-pin',
        'plane', 'train-front', 'car', 'bus', 'bike', 'ship', 'luggage', 'hotel',
        'shopping-cart', 'store', 'gift', 'wallet', 'credit-card', 'receipt', 'coins', 'circle-dollar-sign',
        'chart-line', 'trending-up', 'calculator', 'bitcoin', 'heart-pulse', 'hospital', 'stethoscope', 'pill',
        'dumbbell', 'apple', 'utensils', 'coffee', 'book', 'graduation-cap', 'school', 'pencil',
        'notebook-pen', 'headphones', 'podcast', 'film', 'tv', 'newspaper', 'mic', 'speaker',
        'user', 'users', 'briefcase', 'download', 'upload', 'share-2', 'send', 'printer',
        'wrench', 'palette', 'layers', 'eye', 'keyboard', 'laptop', 'smartphone', 'sun',
        'moon', 'mountain', 'trees', 'paw-print', 'ticket', 'timer', 'bluetooth', 'satellite',
        'rss', 'play', 'messages-square',
    ];
